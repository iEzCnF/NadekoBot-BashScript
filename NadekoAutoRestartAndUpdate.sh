...
if [ $choice -eq 1 ] ; then
	echo ""
	curl -L https://github.com/iEzCnF/NadekoBot-BashScript/raw/master/NadekoARN.sh | sh
else
	if [ $choice -eq 2 ] ; then
		echo ""
		curl -L https://github.com/iEzCnF/NadekoBot-BashScript/raw/master/NadekoARU_Latest.sh | sh
	else
		if [ $choice -eq 3 ] ; then
			echo ""
			curl -L https://github.com/iEzCnF/NadekoBot-BashScript/raw/master/NadekoARU_Stable.sh | sh
		else
			if [ $choice -eq 4 ] ; then
				echo ""
				echo "Exiting..."
